...
> `rootmeup/`** et avec une coquille (« beach » au lieu de « breach »). Elle fonctionne (le nom
> configuré dans CTFd correspond à l'image buildée), mais à harmoniser côté Lucas avec la
> convention `rootmeup/<code>:1.0`.
